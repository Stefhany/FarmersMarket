                            ...
                            <div class="cuerpo" style="width: 85%; height: 520px; left: 25%;  float: right;">
                                ...
                                <div class="derecha">
                                    <center>
                                        ...
                                        <table border="1" id="results" class="table table-bordered" style="width:95%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="listarofertas.jsp?idOffer=<%=ofer.getIdOfertas()%>"><img src="../imagenes/order.png" width="32" height="32" alt="Solicitar <%=ofer.getProducts().getNombre()%>" 
                                        ...
                                        <a href="reporteofertas.jsp"><img src="../imagenes/excel.png" width="32" height="32" title="Descargar en Excel" alt="Generar excel"></a>
