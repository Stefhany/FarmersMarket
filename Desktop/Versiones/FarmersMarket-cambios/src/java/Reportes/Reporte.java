...
public class Reporte extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("application/pdf");
        ...
        ReportePruebaDAO rdao = new ReportePruebaDAO();
        ArrayList<ReportePruebaDTO> usuarios = new ArrayList();
        usuarios = rdao.mostrarPrueba();
        //out.print(usuarios.size());
       
        try
        {
            //JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("WEB-INF/reportePrueba.jasper"));
